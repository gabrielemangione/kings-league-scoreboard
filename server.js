...
const server = http.createServer((req, res) => {
  ...
  if (pathname === '/') pathname = '/controller.html';
...
server.listen(PORT, HOST, () => {
  console.log(`Kings League Scoreboard running on http://${HOST}:${PORT}`);
  console.log(`Overlay:    http://${HOST}:${PORT}/overlay.html`);
  console.log(`Controller: http://${HOST}:${PORT}/controller.html`);
});
